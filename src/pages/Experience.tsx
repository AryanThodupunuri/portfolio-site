    ...
    <main className="flex-1 bg-white dark:bg-gray-950 min-h-screen">
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        <div className="mb-12">
          ...
          <p className="text-gray-500 dark:text-gray-400">My professional journey and education</p>
        </div>
          ...
          <div className="space-y-10">
            {experiences.map((exp, index) => (
              <div key={index} className="relative pl-12">
                <div className={`absolute left-0 top-1 w-8 h-8 rounded-full flex items-center justify-center ring-4 ring-white dark:ring-gray-950 ${exp.upcoming ? 'bg-indigo-500' : 'bg-gray-200 dark:bg-gray-700'}`}>
                  {exp.upcoming ? (
                ...
                <div className="card">
                  <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
                    <div>
                      <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{exp.role}</h2>
