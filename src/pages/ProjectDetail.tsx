...
const projectDetails: { [key: string]: any } = {
  'cloud-sentinel': {
    ...
    highlights: [
      ...
      'Secure AWS connectivity via STS AssumeRole — no long-term credentials stored anywhere in the system',
      ...
      'GitHub issue creation from action plans — AI findings become trackable engineering tasks without humans losing control',
  ...
  'food-ordering-system': {
    ...
    highlights: [
      'Outbox Pattern eliminates the dual-write problem — events are committed atomically with state changes before Kafka publish',
      ...
      'Apache Kafka used exclusively for inter-service communication — no synchronous HTTP calls between domains',
  ...
  slacklite: {
    ...
    highlights: [
      'WebSocket-based real-time fan-out — messages delivered to all channel members without polling',
      'Pre-signed S3 URLs for file uploads — large files go directly to S3, never through the API server',
